...
<html>
	<head>
		<title>Post a one-time ride</title>
		...
		<div id="main">
			...
			<?php			
				...
				if(mysqli_query($link,$rideQuery)){
					...
					$OneTimeRideQuery = "INSERT INTO Single_Ride VALUES('$rideId','$dateOfDep')";
					if(mysqli_query($link,$OneTimeRideQuery)){
						echo "<br><div class='privSelect'>One-time ride added successfully</div><br>";
					} else {
						echo "Error: ".$OneTimeRideQuery."<br>".mysqli_error($link);
					}
				} else {
