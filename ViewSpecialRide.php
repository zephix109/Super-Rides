...
<html>
	<head>
		...
		<title>Special trip details</title>
	...
	<body>
		<div id="main">
			...
			<?php
				...
				$query = "SELECT r.*, s.* FROM Ride r INNER JOIN Special_trip s ON r.id = s.ride_id AND r.id = '$rideID'";
				...
				echo "<tr><th>" . $array[6] . ":</th><td>" . $row['description'] . "</td></tr>";
				echo "<tr><th>" . $array[8] . ":</th><td>" . $row['max_distance'] . "</td></tr>";
