...
<html>
	<head>
		...
		<title>Single ride details</title>
	...
	<body>
		<div id="main">
			...
			<?php
				...
				$query = "SELECT r.*, s.* FROM Ride r INNER JOIN Single_Ride s ON r.id = s.ride_id AND r.id = '$rideID'";
				...
				echo "<tr><th>" . $array[6] . ":</th><td>" . $row['date_of_departure'] . "</td></tr>";
