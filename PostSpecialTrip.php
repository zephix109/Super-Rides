...
<html>
	...
	<body>
		<div id="main">
			...
			<p id="regPage">
				<span id="regTitle">Post a special trip</span>
				<form name="postRideForm" id="registration" method="post" action="PostSpecialTrip_Action.php">
					...
					<input type="text" name="maxDistance" class="regData1" value="Max distance" onfocus="clearMaxDistance()"/><br>
					<input type="text" name="tripDescription" class="regData3" value="Trip description" onfocus="clearTripDescription()"/><br>
