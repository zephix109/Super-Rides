...
<html>
	<head>
		<title>Post a reoccurring ride</title>
		...
		<div id="main">
			...
			<?php			
				...
				if(mysqli_query($link,$rideQuery)){
					...
					$ReoccurringRideQuery = "INSERT INTO Reoccurring_ride VALUES('$rideId','$freqOfTrip')";
					if(mysqli_query($link,$ReoccurringRideQuery)){
						echo "<br><div class='privSelect'>Reoccurring ride added successfully</div><br>";
					} else {
						echo "Error: ".$ReoccurringRideQuery."<br>".mysqli_error($link);
					}
				} else {
