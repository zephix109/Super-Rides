...
<html>
	<head>
		<title>Post One-Time Ride</title>
	...
	<body>
		<div id="main">
			...
			<p id="regPage">
				<span id="regTitle">Post a one-time ride</span>
				<form name="postRideForm" id="registration" method="post" action="PostOneTimeRide_Action.php">
					...
					<label class="passText">Date of departure</label>
					<input type="date" name="dateOfDep" class="regData1"/><br>
